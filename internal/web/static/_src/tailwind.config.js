...
module.exports = {
  ...
  safelist: [
    ...
    "wave-section",
    "wave-debug-banner", "wave-matrix-card", "wave-matrix-scroll",
    "wave-matrix", "wave-matrix-corner", "wave-matrix-phase",
    "wave-matrix-unphased", "wave-matrix-wave", "wave-matrix-row",
    "wave-cell", "wave-cell-empty", "wave-cell-link", "wave-cell-static",
    "wave-cell-count", "wave-cell-dots", "wave-matrix-legend",
    "wave-expanded", "wave-expanded-summary", "wave-expanded-body",
    "waves-page",
    "assign-phase-form",
    "phases-index", "phase-detail", "phase-summary", "phases-empty",
    "phase-row", "phase-row-summary", "phase-row-chevron",
    "phase-row-name", "phase-row-slug",
    "phase-row-counts", "phase-row-desc", "phase-row-body",
    "phase-wave", "phase-wave-heading",
